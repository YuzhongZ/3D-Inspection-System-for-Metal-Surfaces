# device settings
device = 'cpu' # or 'cpu''cuda'

# data settings
dataset_dir = './AST-main/dataset/'#./dataset/'#'/path/to/your/dataset/' # parent directory of class folders
feature_dir = './AST-main/features/'#'data/features/' # directory where features are stored and loaded from
use_3D_dataset = True # is MVTec 3D used?
pre_extracted = True#True # were feature pre-extracted with extract_features? (recommended)
